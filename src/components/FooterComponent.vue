  ...
  <footer class="bg-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid md:grid-cols-4 gap-8">
        <div>
          <h5 class="text-xl font-semibold mb-4">CWA</h5>
          <p class="text-gray-400">
            Cornea Web Academy - Advancing ophthalmic education through interactive surgical
            experiences
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            <li v-for="resource in resources" :key="resource.name">
              <a :href="resource.href" class="hover:text-white transition">{{ resource.name }}</a>
            </li>
          </ul>
        </div>
        <div>
      ...
      <div class="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
        <p>&copy; 2025 CWA - Cornea Web Academy. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
