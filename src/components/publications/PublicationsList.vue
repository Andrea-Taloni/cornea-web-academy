  ...
  <section class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div v-if="filteredPublications.length === 0" class="text-center py-12 bg-gray-50 rounded-lg">
        ...
        <h3 class="mt-2 text-lg font-medium text-gray-900">{{ $t('publications.noPublicationsFound') }}</h3>
        <p class="mt-1 text-sm text-gray-500">{{ $t('publications.tryAdjustingSearch') }}</p>
      </div>
