<!-- src/views/surgery/DSAEKView.vue -->
<template>
...
// Import all DSAEK section components
import IntroductionSection from './dsaek/_Introduction.vue'
import IndicationsSection from './dsaek/_Indications.vue'
import SurgerySection from './dsaek/_Surgery.vue'
import ResultsSection from './dsaek/_Results.vue'
import ComplicationsSection from './dsaek/_Complications.vue'
import PostopSection from './dsaek/_Postop.vue'
import ReferencesSection from './dsaek/_References.vue'
