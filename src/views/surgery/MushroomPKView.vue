<!-- src/views/surgery/MushroomPKView.vue -->
<template>
  <div class="min-h-screen bg-gray-50">
    <HeaderComponent />

    <!-- Hero Section -->
    <PageHero title="Mushroom PK" subtitle="Two-piece Mushroom Penetrating Keratoplasty" />
...
// Import all Mushroom PK section components
import IntroductionSection from './mushroompk/_Introduction.vue'
import IndicationsSection from './mushroompk/_Indications.vue'
import SurgerySection from './mushroompk/_Surgery.vue'
import ResultsSection from './mushroompk/_Results.vue'
import ComplicationsSection from './mushroompk/_Complications.vue'
import PostopSection from './mushroompk/_Postop.vue'
import ReferencesSection from './mushroompk/_References.vue'
